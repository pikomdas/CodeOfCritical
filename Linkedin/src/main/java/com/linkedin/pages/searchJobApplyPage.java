...
public class searchJobApplyPage extends browser
{
	...
	@FindAll({ @FindBy(xpath = "//*[@class='jobs-search-results__list artdeco-list']/li/div/artdeco-entity-lockup/artdeco-entity-lockup-content/h3") })
	...
	/*
	 * ONLY This method will be called to apply job
	 */
...
//				Log.info("Company name is: " + f.getText().toString());
