...
public class JSONBuilder {
    ...
    private static volatile List<JSONObject> jsonData1 = new CopyOnWriteArrayList<>();
    ...
    public synchronized void collectData(String scenarioId,String sessionId, String currentTagName, String scenarioName, String positionName, String columnName, String fromJSON,
                                         String fromUI, List<String> screenshotLocation, String executionDate) {
        JSONObject jo = new JSONObject();
        //Adding Session ID and Current tagName and Current User and ScenarioId
...
//      Storing the JSONObject inside arraylist
    ...
    public synchronized JSONObject getJSONObject() {
        ...
        for (int i = 0; i < jsonData.size(); i++) {
            ...
            String sId = (String) jsonData.get(i).get("Scenario ID");
