...
public class DataCollector
{
    ...
    private final ThreadLocal<Scenario> scenarioId = new ThreadLocal<>();
...
//                    System.out.println("Thread: " + Thread.currentThread().getName());
                    jsonBuilder.collectData(scenarioId.get().getId(),sessionId.get(), currentTagName.get(), scenarioName.get(), x.getPageName(), x.getFieldName(), x.getExpectedValue(),
