...
class MethodScanner
{
			...
			if (annotation != null)
			{
				...
				if (!glueCodeClass.equals(method.getDeclaringClass()))
				{
					throw new CucumberException(String.format(
							...
							glueCodeClass, method.getDeclaringClass()));
				}
	...
	private Collection<Class<? extends Annotation>> findCucumberAnnotationClasses() {
		Collection<Class<? extends Annotation>> descendants = classFinder.getDescendants(Annotation.class,
				"cucumber.api");
		return descendants;
	}
	...
	private boolean isHookAnnotation(Annotation annotation) {
		...
		boolean isHook = annotationClass.equals(Before.class) || annotationClass.equals(After.class)
				|| annotationClass.equals(BeforeStep.class) || annotationClass.equals(AfterStep.class);
		return isHook;
	}
